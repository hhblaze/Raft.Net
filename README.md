...
Implementation of the [RAFT](https://raft.github.io/) distributed consensus algorithm among TCP peers with disk or memory data persistence.<br />.NET / dotnet / netstandard /netcore<br />
