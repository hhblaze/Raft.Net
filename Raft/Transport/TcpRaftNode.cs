...
namespace Raft.Transport
{
    public class TcpRaftNode: IEmulatedNode, IDisposable
    {
        ...
        public TcpRaftNode(List<TcpClusterEndPoint> clusterEndPoints, List<RaftNodeSettings> raftNodes, string dbreezePath, Action<string, ulong, byte[]> OnCommit, int port = 4250,  IWarningLog log = null)
        {
