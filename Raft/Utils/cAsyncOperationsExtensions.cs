...
{
    internal static class cAsyncOperationsExtensions
    {

        /*
            Func<string,string> f1 = (sInput) =>
            {
                SH.IFatAssembly i = AddInManager.GetComposedInterface<SH.IFatAssembly>();
                if (i == null)
                    return String.Empty;
                else
                    return i.CallIndependentInterface();
            };

            f1.DoAsync<string, string>(String.Empty, r =>
            {
                AddMessage(r);
            });
        */
        ...
        /*
         Func<string> f = () =>
            ...
            f.DoAsync<string>(r => AddMessage(r));
        */
        ...
        {
            f.BeginInvoke(arg, x => { f.EndInvoke(x); }, null);
        }
